        ...
        <div className='flex items-center sm:divide-x divide-gray-300'>
          ...
          </div>
          {
              Object.values(providers).map((provider) =>(
                ...
                <div className='pl-4'>
                <button onClick={() => signIn(provider.id, { callbackUrl: "/" })} className='text-blue-700 font-semibold rounded-full  border border-blue-700 px-5 py-1.5 transition-all hover:border-2'>
                  Sign in
                </button>
              </div>
              </div>
